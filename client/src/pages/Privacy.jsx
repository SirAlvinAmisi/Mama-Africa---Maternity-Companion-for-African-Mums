  ...
  return (
    <div className="bg-white flex flex-col w-full">
      <main className="flex-1">
        ...
        <section className="container mx-auto px-6 pt-16 bg-cyan-400 pb-8">
          <h1 className="font-montserrat font-bold text-cyan-900 text-2xl text-center mb-12">
            Data Privacy Policy
          </h1>
          ...
          <div className="flex flex-col gap-8 w-full max-w-[930px] mx-auto">
            ...
            <div className="bg-cards-color rounded-[20px] p-8">
              <h2 className="font-montserrat font-bold text-cyan-900 text-2xl mb-4">
                Introduction
              </h2>
              <p className="font-montserrat font-medium text-black text-sm">
            ...
            <div className="bg-cards-color rounded-[20px] p-8">
              <h2 className="font-montserrat font-bold text-cyan-900 text-2xlmb-4">
                Data Collection
              </h2>
              <p className="font-montserrat font-medium text-black text-sm">
            ...
            <div className="bg-cards-color rounded-[20px] p-8">
              ...
              <p className="font-montserrat ffont-medium text-black text-sm">
