...
const Specialists = () => {
  ...
  <div className="flex flex-col min-h-screen bg-white">
    ...
    <section className="py-16 px-4 sm:px-8 bg-cyan-50">
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-center text-cyan-700 mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
        {[
          ...
          <div
            key={index}
            className="bg-white p-6 rounded-lg shadow-md flex items-center justify-center text-sm sm:text-base md:text-lg font-medium text-cyan-700 text-center"
          >
            {specialty}
          </div>
        ))}
        ...
        {specialists.map((specialist) => (
          ...
          >
            ...
            <div className="flex gap-4">
              <button className="bg-cyan-600 text-white rounded-full px-4 py-2 mt-4 hover:bg-cyan-700 text-xs sm:text-sm font-medium">
                View Profile
              </button>
            </div>
          </div>
            ...
            >
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="text-xs sm:text-sm bg-cyan-600 hover:bg-cyan-700 text-white px-4 py-2 rounded-full font-medium transition"
                >
                  Read More
                </button>
              </div>
